...
Mod_AddonSkins:RegisterSkin("Recount",function(Skin, skin, Layout, layout, config)
	...
	local function SkinFrame(frame)
	    ...
	    skin:SkinBackgroundFrame(frame.bgTitle)
	    frame.bgTitle:SetPoint("TOPRIGHT",frame,"TOPRIGHT",0,-10)
	    frame.bgTitle:SetPoint("TOPLEFT",frame,"TOPLEFT",0,-9)
	    frame.bgTitle:SetPoint("BOTTOM",frame,"TOP",0,-29)
	    frame.bgTitle:SetFrameStrata("LOW")
	    frame.bgTitle:SetFrameLevel(31)
	    frame.CloseButton:SetPoint("TOPRIGHT",frame,"TOPRIGHT",-1,-9)
	    frame.Title:SetPoint("TOPLEFT",frame,"TOPLEFT",2,-12)
